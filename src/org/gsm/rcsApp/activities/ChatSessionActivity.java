...
public class ChatSessionActivity extends Activity implements Runnable {
	 ...
	 */
	private void sendComposingIndicator(String userId, String contactId, String state, int refresh, java.util.Date lastActive, String contentType) throws UnsupportedEncodingException {
